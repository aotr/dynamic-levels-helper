...
/**
 * Amount Format Helper - Usage Examples
 * 
 * This file demonstrates all the features and usage patterns
 * of the amount_format helper function.
 */

// Include the helpers (normally loaded automatically by Laravel)
...
echo "Complex config positive: " . amount_format(1234.567, $complexOptions) . "\n";
echo "Complex config negative: " . amount_format(-1234.000, $complexOptions) . "\n\n";
...
// Blade Directive Examples (would be used in Blade templates)
...
for ($i = 0; $i < 1000; $i++) {
    amount_format(rand(1000, 10000000));
}
$end = microtime(true);
echo "Formatted 1000 random numbers in " . round(($end - $start) * 1000, 2) . " milliseconds\n\n";
